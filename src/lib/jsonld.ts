...
export function businessJsonLd(): JsonLd {
  return {
    ...
    description:
      "Brooklyn-based photo booth rental and interactive event experience company serving corporate events, trade shows, brand activations, weddings and special occasions throughout New York City and the tri-state area. Mirror, 360, glam, vogue, roaming, green screen, enclosed, AI, GIF, magazine, studio and 3D slider booths, plus the Glambot, mosaic walls, champagne walls and flower walls.",
    address: {
      "@type": "PostalAddress",
